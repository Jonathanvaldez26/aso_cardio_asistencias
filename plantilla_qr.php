			...
			<div class="row">
				<div class="col-lg-offset-4 col-lg-4 col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12">
					<div class="panel panel-primary">
						<div class="panel-heading" style="background-color: #4682c8;">
							...
							<div class="form-group">
								<div class="input-group">
									...
									<span class="input-group-addon" style="padding:1px;">
										<button id="btnBuscar" name="btnBuscar" type="button" class="btn btn-primary btn-sm" style="background-color: #4682c8;"><i class="fa fa-search fa-lg"></i></button>
									</span>
								</div>
							</div>
